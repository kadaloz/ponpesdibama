...
Route::middleware(['auth'])->prefix('admin')->name('admin.')->group(function () {
    ...
    Route::get('settings/delete-photo/{key}', [SettingController::class, 'deletePhoto'])->name('settings.delete_photo')  ->middleware('permission:manage settings');
    Route::get('settings/delete-all-photos', [SettingController::class, 'deleteAllPhotos'])->name('settings.delete_all_photos')  ->middleware('permission:manage settings');
...
Route::get('/api/available-students', function (Request $request) {
    ...
    $students = Student::query()
        ->where('status', 'aktif')
        ->whereDoesntHave('currentRoomPlacement', function ($q) {
    ...
    Route::post('/placements', [StudentPlacementController::class, 'store'])->name('placements.store')  ->middleware('permission:create placements');
    ...
    Route::get('payments/export/', [PaymentController::class, 'export'])->name('payments.export')->middleware('permission:export payments');
