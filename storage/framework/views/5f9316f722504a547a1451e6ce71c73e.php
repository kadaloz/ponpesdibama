...
<?php endif; ?> Pendaftaran PPDB
            ...
            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('edit ppdb requirements')): ?>
                <li>
                    <a href="<?php echo e(route('admin.ppdb-requirements.edit')); ?>" class="flex items-center px-4 py-2 rounded-lg hover:bg-teal-700 hover:shadow-md <?php echo e(request()->routeIs('ppdb_requirements.*') ? 'bg-teal-700 text-white shadow-md' : 'text-teal-100'); ?>">
                        <?php if (isset($component)) { $__componentOriginal643fe1b47aec0b76658e1a0200b34b2c = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal643fe1b47aec0b76658e1a0200b34b2c = $attributes; } ?>
<?php $component = BladeUI\Icons\Components\Svg::resolve([] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?> Manajemen Pengajar
            ...
            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('view general management')): ?>
                <li>
                    <a href="<?php echo e(route('admin.general.dashboard')); ?>" class="flex items-center px-4 py-2 rounded-lg hover:bg-teal-700 hover:shadow-md <?php echo e(request()->routeIs('admin.general.*') ? 'bg-teal-700 text-white shadow-md' : 'text-teal-100'); ?>">
                        <?php if (isset($component)) { $__componentOriginal643fe1b47aec0b76658e1a0200b34b2c = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal643fe1b47aec0b76658e1a0200b34b2c = $attributes; } ?>
<?php $component = BladeUI\Icons\Components\Svg::resolve([] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?> Keuangan
            ...
            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('manage dormitories')): ?>
                <li>
                    <a href="#" class="flex items-center px-4 py-2 rounded-lg hover:bg-teal-700 hover:shadow-md text-teal-100">
                        <?php if (isset($component)) { $__componentOriginal643fe1b47aec0b76658e1a0200b34b2c = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal643fe1b47aec0b76658e1a0200b34b2c = $attributes; } ?>
...
<?php /**PATH /Users/husnulfuadifebriansyah/Documents/dari git/ponpesdibama/resources/views/admin/sidebar.blade.php ENDPATH**/ ?>