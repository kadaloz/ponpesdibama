    ...
    <div class="p-8 text-gray-900">
        <div class="flex flex-col md:flex-row justify-between items-center mb-8">
            ...
            <div class="flex flex-col sm:flex-row flex-wrap gap-2 sm:gap-4">
                ...
                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('create students')): ?>
                <a href="<?php echo e(route('admin.students.create')); ?>" class="inline-flex items-center justify-center px-5 py-2.5 bg-teal-600 border border-transparent rounded-lg font-semibold text-sm text-white hover:bg-teal-700 focus:outline-none focus:ring-2 focus:ring-teal-400 shadow-md">
                ...
                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('export students')): ?>
                <a href="<?php echo e(route('admin.students.export')); ?>" class="inline-flex items-center justify-center px-5 py-2.5 bg-green-600 border border-transparent rounded-lg font-semibold text-sm text-white hover:bg-green-700 focus:outline-none focus:ring-2 focus:ring-green-400 shadow-md">
                    <svg class="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('import students')): ?>
                ...
                <tbody class="bg-white divide-y divide-gray-200">
                    <?php $__empty_1 = true; $__currentLoopData = $allStudents; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $student): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <tr class="hover:bg-gray-50">
                            ...
                            <td class="px-6 py-4"><?php echo e($student->gender ? ucwords(strtolower($student->gender)) : '-'); ?></td>
                            ...
                            <td class="px-6 py-4 text-center">
                                <div class="flex justify-center flex-wrap gap-2">
                                    ...
                                    <a href="<?php echo e(route('admin.students.edit', $student)); ?>" class="text-sm px-3 py-1 bg-indigo-600 text-white rounded-full hover:bg-indigo-700">Edit</a>
                                    <?php endif; ?>

                                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('delete students')): ?>
                                    <form action="<?php echo e(route('admin.students.destroy', $student)); ?>" method="POST" onsubmit="return confirm('Apakah Anda yakin ingin menghapus?');">
                                        <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/husnulfuadifebriansyah/Documents/dari git/ponpesdibama/resources/views/admin/students/index.blade.php ENDPATH**/ ?>