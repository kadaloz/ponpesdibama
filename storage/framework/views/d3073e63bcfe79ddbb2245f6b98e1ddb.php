        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-10 text-center md:text-left">
            ...
            <div>
                ...
                <ul class="space-y-2 text-sm">
                    <li><a href="<?php echo e(url('/ppdb/daftar')); ?>" class="hover:underline text-gray-300 hover:text-white transition">Pendaftaran PPDB</a></li>
...
<div class="border-t border-teal-700 mt-10 pt-6 text-center">
    <div class="flex justify-center items-center gap-3">
        <img src="<?php echo e(asset('storage/images/logo/project.png')); ?>" alt="Logo Project"
             class="h-6 w-auto rounded shadow-md">
        <img src="<?php echo e(asset('storage/images/logo/academy.png')); ?>" alt="Logo Academy"
             class="h-6 w-auto rounded shadow-md">
        <img src="<?php echo e(asset('storage/images/logo/yadun-ulya.png')); ?>" alt="Logo Yadun Ulya"
             class="h-6 w-auto rounded shadow-md">
        <img src="<?php echo e(asset('storage/images/logo/camping.png')); ?>" alt="Logo Camping Qur'an"
             class="h-6 w-auto rounded shadow-md">
    </div>
</div>
...
<?php /**PATH /Users/husnulfuadifebriansyah/Documents/dari git/ponpesdibama/resources/views/web/footer.blade.php ENDPATH**/ ?>