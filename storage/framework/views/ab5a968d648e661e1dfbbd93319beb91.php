            ...
            <?php $__currentLoopData = $steps; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $step): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="relative flex-1 group">
                    ...
                    <div class="relative z-10 flex flex-col items-center text-center px-5 py-6 bg-white rounded-xl shadow-md hover:shadow-lg transition-all duration-300 ease-in-out">
                        ...
                        <p class="text-sm font-medium text-gray-800"><?php echo e($step); ?></p>
                    </div>
                </div>
...
<?php /**PATH /Users/husnulfuadifebriansyah/Documents/dari git/ponpesdibama/resources/views/components/ppdb/requirements.blade.php ENDPATH**/ ?>