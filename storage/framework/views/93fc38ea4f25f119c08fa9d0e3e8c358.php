...
<div x-data="{ ppdbOpen: <?php echo e(old('is_ppdb_open', $settings['is_ppdb_open']) ? 'true' : 'false'); ?> }">
    ...
    <div class="pt-4 border-t border-gray-200">
        ...
        <div class="flex items-center space-x-3">
            ...
            <input
                ...
                <?php echo e(old('is_ppdb_open', $settings['is_ppdb_open']) ? 'checked' : ''); ?>
        ...
        <div class="flex items-center space-x-6">
            ...
            <div class="flex items-center space-x-2">
                ...
                <input
                    ...
                    value="1"
                    class="h-5 w-5 text-teal-600 border-gray-300 rounded"
                    <?php echo e(old('ppdb_asrama_open', $settings['ppdb_asrama_open']) ? 'checked' : ''); ?>
            ...
            <div class="flex items-center space-x-2">
                ...
                <input
                    ...
                    value="1"
                    class="h-5 w-5 text-teal-600 border-gray-300 rounded"
                    <?php echo e(old('ppdb_pulang_pergi_open', $settings['ppdb_pulang_pergi_open']) ? 'checked' : ''); ?>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/husnulfuadifebriansyah/Documents/dari git/ponpesdibama/resources/views/admin/settings/edit.blade.php ENDPATH**/ ?>