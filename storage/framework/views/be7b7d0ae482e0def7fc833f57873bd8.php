...
<section id="ppdb-form" class="py-16 md:py-24 bg-gray-50 text-gray-800">
    <div class="container mx-auto px-4">
        ...
        <div class="bg-white p-6 md:p-10 rounded-2xl shadow-xl max-w-4xl mx-auto">
            ...
            <form id="ppdbForm" action="<?php echo e(route('ppdb.store')); ?>" method="POST" enctype="multipart/form-data" class="space-y-6 text-left" autocomplete="off">
                <?php echo csrf_field(); ?>
...
<script>
    ...
    document.addEventListener('DOMContentLoaded', function () {
        ...
        form.addEventListener('submit', function (e) {
            ...
            grecaptcha.ready(function () {
                grecaptcha.execute("<?php echo e(config('services.recaptcha.site_key')); ?>", {action: 'ppdb_form'}).then(function (token) {
    ...
    const selectedProv = "<?php echo e(old('province', $applicant->province ?? '')); ?>";
    const selectedKab = "<?php echo e(old('city', $applicant->city ?? '')); ?>";
...
<?php echo $__env->make('web.apps', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/u448104011/domains/ponpesdibama.com/public_html/resources/views/public/applicants/create.blade.php ENDPATH**/ ?>