...
<a href="#program"
   class="inline-flex items-center justify-center mt-10 px-8 py-4 bg-white text-teal-700 font-semibold text-base md:text-lg rounded-full shadow-xl hover:bg-teal-50 transition-transform duration-300 transform hover:scale-105 ring-2 ring-white/30 animate-bounce">
    ...
    <!-- Floating Navigation -->
    <nav class="sticky top-[80px] bg-white bg-opacity-95 backdrop-blur-md shadow-xl p-3 rounded-full mx-auto max-w-fit mt-6 z-40 transform transition-all duration-300 border border-gray-200"> 
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('web.apps', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/u448104011/domains/ponpesdibama.com/public_html/resources/views/home.blade.php ENDPATH**/ ?>