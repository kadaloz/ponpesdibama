...
<?php $__env->startSection('header_admin', 'Manajemen Berita & Pengumuman'); ?>
                        ...
                        <tbody class="bg-white divide-y divide-gray-200">
                            <?php $__currentLoopData = $allNews; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $newsItem): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr class="even:bg-gray-50 hover:bg-gray-100 transition-colors duration-150">
                                    <td class="py-4 px-6 text-sm font-medium text-gray-900"><?php echo e($newsItem->title); ?></td>
                                    <td class="py-4 px-6 text-sm text-gray-700"><?php echo e($newsItem->category?->name ?? 'Umum'); ?></td>
                                    <td class="py-4 px-6">
                                        <?php if($newsItem->image): ?>
                                            <img src="<?php echo e(asset('storage/' . $newsItem->image)); ?>" alt="<?php echo e($newsItem->title); ?>" class="h-16 w-16 object-cover rounded-md border border-gray-200 shadow-sm">
                                        <?php else: ?>
                                            <span class="text-gray-400 text-sm italic">Tidak ada gambar</span>
                                        <?php endif; ?>
                                    </td>
                                    <td class="py-4 px-6 text-sm text-gray-600">
                                        <?php echo e($newsItem->published_at ? \Carbon\Carbon::parse($newsItem->published_at)->format('d M Y') : 'Belum Dipublikasi'); ?>
                                    ...
                                    <td class="py-4 px-6 text-center text-sm font-medium whitespace-nowrap">
                                        ...
                                        <form action="<?php echo e(route('admin.news.destroy', $newsItem)); ?>" method="POST" class="inline-block ml-3" onsubmit="return confirm('Apakah Anda yakin ingin menghapus berita ini? Aksi ini tidak dapat dibatalkan.');">
                                            <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/u448104011/domains/ponpesdibama.com/public_html/resources/views/admin/news/index.blade.php ENDPATH**/ ?>