...
$__newAttributes = [];
$__propNames = \Illuminate\View\ComponentAttributeBag::extractPropNames((['student' => null]));
...
foreach (array_filter((['student' => null]), 'is_string', ARRAY_FILTER_USE_KEY) as $__key => $__value) {
    $$__key = $$__key ?? $__value;
}
...
<script>
    document.addEventListener('DOMContentLoaded', function () {
        ...
        const selectedProv = "<?php echo e(old('province', $student->province ?? '')); ?>".trim();
        const selectedKab = "<?php echo e(old('city', $student->city ?? '')); ?>".trim();
        const selectedKec = "<?php echo e(old('district', $student->district ?? '')); ?>".trim();
        const selectedKel = "<?php echo e(old('village', $student->village ?? '')); ?>".trim();
...
<?php $__env->stopPush(); ?><?php /**PATH /Users/husnulfuadifebriansyah/Documents/dari git/ponpesdibama/resources/views/components/scripts/region-scripts.blade.php ENDPATH**/ ?>