    ...
    <div class="p-6 text-gray-900">
        ...
        <form action="{{ route('admin.placements.store') }}" method="POST">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <select name="room_id" id="room_id"
                        class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm p-2 focus:ring-teal-500 focus:border-teal-500 @error('room_id') border-red-500 @enderror" required>
            ...
            <div class="mt-6 flex justify-end space-x-3">
                <a href="{{ route('admin.placements.index') }}" class="px-4 py-2 bg-gray-200 rounded font-semibold text-xs text-gray-700 hover:bg-gray-300">Batal</a>
