...
<div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
    <div class="p-8 text-gray-900">
        ...
        ---
        ## Filter Data Santri
        <div class="bg-gray-50 p-6 rounded-lg shadow-md mb-6 border border-gray-200"> {{-- Card untuk Filter --}}
            <form method="GET" action="{{ route('admin.students.index') }}">
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-5 gap-4 items-end">
                    ...
                    <div class="flex gap-2 col-span-full mt-2"> {{-- Tombol akan menempati lebar penuh --}}
