        ...
        <div class="overflow-x-auto bg-white rounded-lg shadow-xl border border-gray-200">
            <table class="min-w-full divide-y divide-gray-200 text-sm">
                <thead class="bg-gray-100">
                    <tr>
                        <th class="px-6 py-3 text-left font-medium text-gray-700">No</th> {{-- Tambahkan kolom No --}}
                ...
                <tbody class="bg-white divide-y divide-gray-200">
                    @forelse ($allStudents as $index => $student) {{-- Tambahkan $index --}}
                        <tr class="hover:bg-gray-50">
                            <td class="px-6 py-4">{{ $allStudents->firstItem() + $index }}</td> {{-- Tampilkan nomor urut --}}
                    ...
                    @empty
                        <tr>
                            <td colspan="6" class="text-center py-12"> {{-- Ubah colspan menjadi 6 --}}
