...
@section('title', 'Beranda - Pondok Dibama')

@section('main_content')
<!-- Hero Section -->
<section id="beranda"
         class="relative bg-gradient-to-r from-teal-700 to-emerald-700 text-white py-16 sm:py-20 md:py-24 flex items-center justify-center min-h-[60vh] md:min-h-[70vh] lg:min-h-[80vh] rounded-b-3xl shadow-2xl overflow-hidden">
    ...
    <div class="relative z-10 text-center px-4 max-w-4xl mx-auto">
        ...
        <div class="flex justify-center items-center mb-2 sm:mb-3 md:mb-4">
            <img src="{{ asset('storage/images/logo/pondok.png') }}"
                alt="Logo Pondok"
                class="h-16 sm:h-20 md:h-24 lg:h-28 xl:h-32 w-auto max-w-[160px] rounded-md shadow-xl transition-transform duration-300 ease-in-out animate-fade-in-down">
        </div>
        ...
        <!-- Tombol CTA -->
        <a href="#program"
            class="inline-flex items-center justify-center mt-8 px-8 py-4 bg-white text-teal-700 font-semibold text-base md:text-lg rounded-full shadow-xl hover:bg-teal-50 transition-transform duration-300 transform hover:scale-105 ring-2 ring-white/30 animate-bounce">
            Lihat Program Kami
...
<section id="program" class="py-20 md:py-32 bg-teal-50 rounded-3xl shadow-xl mx-4 md:mx-auto max-w-7xl my-16 animate-fade-in-up">
    ...
    <section id="nasihat-harian" class="py-20 md:py-32 bg-white rounded-3xl shadow-xl mx-4 md:mx-auto max-w-7xl my-16 animate-fade-in-up"> {{-- Padding, rounded, shadow lebih menonjol --}}
        <div class="container mx-auto px-6 text-center">
            ...
            <button id="getDailyAdviceBtn" class="bg-teal-700 text-white px-8 py-4 rounded-full text-lg font-semibold hover:bg-teal-800 transition-colors shadow-lg flex items-center justify-center mx-auto transform hover:scale-105"> {{-- Transform hover --}}
                Dapatkan Nasihat ✨
...
<section id="berita" class="py-20 md:py-32 bg-teal-50 rounded-3xl shadow-xl mx-4 md:mx-auto max-w-7xl my-16 animate-fade-in-up">
            ...
            @forelse ($latestNews as $newsItem)
                ...
                <div class="bg-white rounded-2xl border border-gray-100 shadow-md hover:shadow-xl overflow-hidden transition-transform duration-300 hover:scale-[1.02]">
                    ...
                    <div class="p-6">
                        ...
                        <h3 class="text-xl font-bold text-teal-700 mb-2">{{ $newsItem->title }}</h3>
                        <p class="text-gray-600 leading-relaxed mb-4">{{ Str::limit(strip_tags($newsItem->content), 150) }}</p>
 ...
 <!-- Call to Action for Enrollment (Moved after Pendaftaran Section) -->
        ...
        <section id="pendaftaran" class="py-20 md:py-32 bg-teal-600 text-white text-center rounded-3xl shadow-xl mx-4 md:mx-auto max-w-7xl my-16 animate-fade-in-up">
            <div class="container mx-auto px-6">
                <h2 class="text-3xl md:text-5xl font-extrabold mb-6 leading-tight drop-shadow-md">
                    {{ $ctaEnrollmentHeading ?? 'Siapkan Masa Depan Gemilang Putra/Putri Anda Bersama PonpesDIBAMA!' }} {{-- Display dynamic heading --}}
                </h2>
                <p class="text-xl md:text-2xl mb-10 opacity-90">
                    Pendaftaran santri baru tahun ajaran {{ $ppdbAcademicYear }} telah dibuka.
                </p>
                <a href="{{ route('ppdb.create') }}" class="inline-flex items-center justify-center bg-white text-teal-700 px-12 py-6 rounded-full text-xl font-bold shadow-2xl transition-all duration-300 transform hover:scale-110 ring-4 ring-white ring-opacity-50">
                    Daftar Sekarang!
    ...
    @else
        {{-- Section Alternatif untuk CTA jika PPDB Tidak Aktif --}}
                ...
                @foreach ($galleries as $gallery)
                    <div class="bg-white rounded-2xl border border-gray-100 shadow-md hover:shadow-xl overflow-hidden transition-all duration-300 hover:scale-[1.02]">
                        ...
                        <div class="p-6 text-center">
                            ...
                            <a href="{{ route('public.galleries.show', $gallery->slug) }}"
                               class="inline-flex items-center text-teal-600 hover:text-teal-800 font-semibold group transition-all duration-200">
