...
<nav class="sticky top-[80px] z-40 mx-auto mt-6 max-w-max px-6 py-6 bg-white/80 backdrop-blur-md border border-gray-200 shadow-lg rounded-full transition-all duration-300 hover:shadow-xl">
