...
@php
    ...
    $ppdbAcademicYear = $settings['ppdb_academic_year'] ?? now()->format('Y') . '/' . now()->addYear()->format('Y');
        ...
        <div class="container mx-auto px-6">
            ...
            <a href="#kontak" class="inline-flex items-center px-8 py-4 bg-teal-500 text-white rounded-full text-lg font-semibold shadow-lg transition-all duration-300 transform hover:scale-105">
                ...
                <svg class="w-5 h-5 ml-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.135a11.042 11.042 0 005.516 5.516l1.135-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.948V19a2 2 0 01-2 2H5a2 2 0 01-2-2V5z"></path>
                </svg>
            </a>
        </div>
    </section>
