...
<div class="space-y-6">
    ...
    <div class="p-6 bg-teal-50 rounded-xl shadow-inner border border-teal-200">
        <h4 class="font-bold text-xl text-teal-700 mb-4 border-b pb-2 flex items-center">
            <x-heroicon-o-user-circle class="h-6 w-6 text-teal-600 mr-2" />
    ...
    <div class="pt-6 border-t border-gray-200 p-6 bg-gray-50 rounded-xl shadow-sm border">
        ...
        <div class="mb-4">
            ...
            <textarea name="address" id="address" rows="3"
                ...
                placeholder="Contoh: Jl. Merpati No. 45, Desa Aikmel">{{ old('address', $student->address ?? '') }}</textarea>
    ...
    <div class="pt-6 border-t border-gray-200 p-6 bg-gray-50 rounded-xl shadow-sm border">
        ...
        @if ($student && $student->photo_path) {{-- Hanya tampilkan jika $student ada dan memiliki foto --}}
    ...
    <div class="pt-6 border-t border-gray-200 p-6 bg-gray-50 rounded-xl shadow-sm border">
        ...
        @foreach ($documentFields as $fileInputName => $label)
            <div class="mb-4">
                ...
                @if ($student && $student->{$fileInputName . '_path'}) {{-- Hanya tampilkan jika $student ada dan memiliki dokumen --}}
    ...
    <div class="pt-6 border-t border-gray-200 p-6 bg-gray-50 rounded-xl shadow-sm border">
        <h4 class="font-bold text-xl text-gray-800 mb-4 border-b pb-2 flex items-center">
            <x-heroicon-o-academic-cap class="h-6 w-6 text-gray-600 mr-2" />
